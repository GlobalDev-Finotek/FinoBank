...
#define SOPT5 30	 // 서명 전체모양 비교에서 오차범위를 규정(%)
#define SOPT6 70	 // 전체 서명 속도 오차범위(%)
#define SOPT7 40	 // 전체 서명 흐름의 오차범위(%) 
#define SOPT8 500	 // 각각의 오브젝트의 서명 흐름의 오차범위(%) 
#define SOPT9 18	 // 각각의 오브젝트 사이의 서명 속도의 오차범위(%) 
#define SOPT10 150   // 각각의 오브젝트의 시작좌표의 오차범위(pixel)
#define SOPT11 150   // 각각의 오브젝트의 끝좌표의 오차범위(pixel)
