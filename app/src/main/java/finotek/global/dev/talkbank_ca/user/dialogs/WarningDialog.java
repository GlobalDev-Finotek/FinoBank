...
import finotek.global.dev.talkbank_ca.databinding.DialogWarningBinding;
...
public class WarningDialog extends Dialog {
	...
	public WarningDialog(@NonNull Context context) {
		...
		binding = DataBindingUtil.inflate(LayoutInflater.from(context), R.layout.dialog_warning, null, false);
