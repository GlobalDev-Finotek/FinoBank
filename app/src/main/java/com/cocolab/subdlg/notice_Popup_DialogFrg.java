...
public class notice_Popup_DialogFrg extends DialogFragment  {
	private Context CTX;
...
//		mainLayout.setBackgroundResource(R.drawable.border_dkgray_blank);
	...
	public notice_Popup_DialogFrg(Context context, String title, String message, int bgColor, View.OnClickListener confirmListener, String ButtonName) {
		super();
		//CTX = context;
