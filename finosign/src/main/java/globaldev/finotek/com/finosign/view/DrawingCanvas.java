...
public class DrawingCanvas extends View {
	...
	private StringBuilder touchDataBuilder = new StringBuilder();
	...
	private void init() {
		...
		drawPaint.setColor(ContextCompat.getColor(context, android.R.color.black));
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		touchDataBuilder.append(String.valueOf(x));
		touchDataBuilder.append(String.valueOf(","));
		touchDataBuilder.append(String.valueOf(y));
		touchDataBuilder.append(String.valueOf(","));
		touchDataBuilder.append(String.valueOf(times));
		touchDataBuilder.append(String.valueOf(","));

		onDrawListener.onDraw(touchDataBuilder.toString());
