...
import finotek.global.dev.brazil.chat.ContextLog.ContextLogReceiver;
import finotek.global.dev.brazil.chat.ContextLog.ContextLogType;
import finotek.global.dev.brazil.chat.messages.ReceiveMessage;
import finotek.global.dev.brazil.chat.messages.RemoteCallCompleted;
import finotek.global.dev.brazil.chat.messages.RequestContactPermission;
import finotek.global.dev.brazil.chat.messages.RequestRemoteCall;
import finotek.global.dev.brazil.chat.messages.RequestTakeAnotherIDCard;
import finotek.global.dev.brazil.chat.messages.SendMessage;
import finotek.global.dev.brazil.chat.messages.action.DismissKeyboard;
import finotek.global.dev.brazil.chat.messages.action.Done;
import finotek.global.dev.brazil.chat.messages.action.EnableToEditMoney;
import finotek.global.dev.brazil.chat.messages.action.RequestKeyboardInput;
import finotek.global.dev.brazil.chat.messages.action.ShowPdfView;
...
import finotek.global.dev.brazil.chat.messages.contact.RequestSelectContact;
import finotek.global.dev.brazil.chat.messages.contact.SelectedContact;
import finotek.global.dev.brazil.chat.messages.context.ContextApp;
import finotek.global.dev.brazil.chat.messages.context.ContextCall;
import finotek.global.dev.brazil.chat.messages.context.ContextLocation;
import finotek.global.dev.brazil.chat.messages.context.ContextLogService;
import finotek.global.dev.brazil.chat.messages.context.ContextScoreReceived;
import finotek.global.dev.brazil.chat.messages.context.ContextSms;
import finotek.global.dev.brazil.chat.messages.context.ContextTotal;
import finotek.global.dev.brazil.chat.messages.context.CurrentAddressReceived;
import finotek.global.dev.brazil.chat.messages.context.RequestCurrentAddress;
...
import finotek.global.dev.brazil.chat.messages.transfer.RequestTransferUI;
import finotek.global.dev.brazil.chat.messages.transfer.RequestTransferUI_v1;
import finotek.global.dev.brazil.chat.messages.transfer.RequestTransferUI_v2;
import finotek.global.dev.brazil.chat.messages.transfer.RequestTransferUI_v3;
import finotek.global.dev.brazil.chat.messages.transfer.TransferButtonPressed;
import finotek.global.dev.brazil.chat.messages.ui.RequestPhoto;
...
import finotek.global.dev.brazil.chat.messages.ui.RequestTakeIDCard;
import finotek.global.dev.brazil.chat.storage.TransactionDB;
import finotek.global.dev.brazil.databinding.ActivityChatBinding;
import finotek.global.dev.brazil.databinding.ChatExtendedControlBinding;
import finotek.global.dev.brazil.databinding.ChatFooterInputBinding;
import finotek.global.dev.brazil.databinding.ChatTransferBinding;
import finotek.global.dev.brazil.inject.component.ChatComponent;
import finotek.global.dev.brazil.inject.component.DaggerChatComponent;
import finotek.global.dev.brazil.inject.module.ActivityModule;
import finotek.global.dev.brazil.model.DBHelper;
import finotek.global.dev.brazil.setting.SettingsActivity;
import finotek.global.dev.brazil.user.CapturePicFragment;
import finotek.global.dev.brazil.user.dialogs.AgreementPdfViewDialog;
...
import finotek.global.dev.brazil.user.dialogs.WarningDialog;
import finotek.global.dev.brazil.user.remotecall.RemoteCallFragment;
import finotek.global.dev.brazil.user.sign.BaseSignRegisterFragment;
import finotek.global.dev.brazil.user.sign.SignRegisterFragment;
import finotek.global.dev.brazil.user.sign.SignValidationFragment;
import finotek.global.dev.brazil.util.ChatLocationListener;
import finotek.global.dev.brazil.util.ContextAuthPref;
import finotek.global.dev.brazil.util.Converter;
import finotek.global.dev.brazil.util.KeyboardUtils;
