...
import finotek.global.dev.brazil.databinding.ActivityUserRegistrationBinding;
...
public class UserRegistrationActivity extends AppCompatActivity implements UserRegisterView {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		binding.llRegiBasic.edtUserName.setText(getString(R.string.default_user_name));
