package finotek.global.dev.brazil.chat.extensions;
...
import finotek.global.dev.brazil.databinding.ChatExControl2Binding;
...
public class ExtendedControl2 extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
		...
		RxView.clicks(binding.btnSendEmail)
				...
				.doOnNext(aVoid -> doOnControl.run())
				.subscribe(aVoid -> {
					MessageBox.INSTANCE.add(new SendMessage(getContext().getString(R.string.main_button_send_the_conversation_to_e_mail), R.drawable.icon_tankbank06));
				});
